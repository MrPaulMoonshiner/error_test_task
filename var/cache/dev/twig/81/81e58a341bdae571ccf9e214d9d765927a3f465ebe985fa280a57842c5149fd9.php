...
class __TwigTemplate_5776e33f9f9c946d97ec09362b7b78732f30aea072e8b9c4dc39baac3feed76b extends \Twig\Template
{
    private $source;
...
{% if admin.hasAccess('create') and admin.hasRoute('create') %}
    ...
    {% endif %}
{% endif %}
", "@SonataAdmin/Button/create_button.html.twig", "/var/www/html/TestTask/vendor/sonata-project/admin-bundle/src/Resources/views/Button/create_button.html.twig");
    }
}
