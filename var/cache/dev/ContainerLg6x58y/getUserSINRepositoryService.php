...
// Returns the private 'App\Repository\UserSINRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/UserSINRepository.php';

return $this->privates['App\Repository\UserSINRepository'] = new \App\Repository\UserSINRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
