...
// Returns the private 'App\Repository\TestTimeRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/TestTimeRepository.php';

return $this->privates['App\Repository\TestTimeRepository'] = new \App\Repository\TestTimeRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
