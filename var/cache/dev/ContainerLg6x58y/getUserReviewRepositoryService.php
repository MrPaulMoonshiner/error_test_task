...
// Returns the private 'App\Repository\UserReviewRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/UserReviewRepository.php';

return $this->privates['App\Repository\UserReviewRepository'] = new \App\Repository\UserReviewRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
